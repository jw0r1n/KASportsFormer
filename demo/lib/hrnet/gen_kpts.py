...
const_args = {
    "cfg": cfg_dir + 'w48_384x288_adam_lr1e-3.yaml',
    "modelDir": model_dir + 'pose_hrnet_w48_384x288.pth',
    "det_dim": 416,
    "thred_score": 0.30,
    "num_person": 1,
    "opts": [],
...
edict_args = EasyDict(const_args)
...
def gen_video_kpts(video, det_dim=416, num_person=1):
