...
class WorldPose3DDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            if self.model_name == "D3DP":
                return (torch.FloatTensor(joint_input), torch.FloatTensor(joint_label), joint_label_scaled, joint_factor, joint_action, joint_res)
            else:
