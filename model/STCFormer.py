...
class Model(nn.Module):
    def __init__(self, args):
        ...
        layers, d_hid, frames = args.layers, args.d_hid, args.num_frame
        num_joints_in, num_joints_out = args.num_joints_in, args.num_joints_out
...
if __name__ == "__main__":
    ...
    inputs = torch.rand([1, 27, 17, 2])  # STCFormer是2通道方法
    output = net(inputs)
    print(output.size())
